...
$res= pg_query($db,"SELECT fb.firstname,fb.surname,fb.email,fb.birthday,fb.gender,profile.image FROM fb,profile WHERE fb.id=profile.userid AND fb.id='$uid'");
        ...
        <div class="row">
            ...
            <div class="col-lg-9" style="height: 600px; "><br>
                ...
                <table border="1" width="40%">
                    <tr>
                        <td colspan="3"><img src="<?php echo $ar['image']?>" style=width:200px; alt=""></td>
                    </tr>
                    
                    <tr>
                        <td style="color:blue;"><b>Email :
                            <?php  echo $ar['email']?></b>
                        </td>
                    </tr>
                    <tr>
                    <td style="color:blue;"><b>DOB :
                            <?php  echo $ar['birthday']?></b>
                        </td>
                    </tr>
                    <tr>
                    <td style="color:blue;"><b>Gender :
                            <?php  echo $ar['gender']?></b>
                        </td>
                    </tr>
