                ...
                <div style="width:500px;">
                    <form method="post" id="selectform" name="pwdform" onsubmit="return pwdvalidate()">
                        <table border="0" cellpadding="10" cellspacing="0" width="500" align="center" class="tblSaveForm">
                            ...
                            <tr>
                                <td width="60%"><input type="password" name="pass" placeholder="𝖤𝗇𝗍𝖾𝗋 𝖢𝗎𝗋𝗋𝖾𝗇𝗍 𝖯𝖺𝗌𝗌𝗐𝗈𝗋𝖽" class="txtField" style="width: 400px; border-radius: 4px;"><span id="currentPassword" class="required"></span></td>
                            </tr>
                            <tr>
                                <td>
                                    <input type="password" placeholder="𝖤𝗇𝗍𝖾𝗋 𝗇𝖾𝗐 𝖯𝖺𝗌𝗌𝗐𝗈𝗋𝖽" name="pass1" class="txtField" style="width: 400px; border-radius: 4px;"><span id=" newPassword " class="required "></span></td>
                            </tr>
                            <td><input type="password " placeholder="𝖢𝗈𝗇𝖿𝗂𝗋𝗆 𝗇𝖾𝗐 𝖯𝖺𝗌𝗌𝗐𝗈𝗋𝖽 " name="cpwd" class="txtField " style="width: 400px; border-radius: 4px;"><span id="confirmPassword " class="required "></span></td>
                            </tr>

                        </table>
                        <button name="btn1" class="btn btn-success" style="width: 200px;">𝗖𝗵𝗮𝗻𝗴𝗲</button>
                        <!-- <input type="submit " name="Change " value="𝗖𝗵𝗮𝗻𝗴𝗲 " class="btn btn-success "> -->
                        <input type="submit " onclick="document.getElementById('selectform').reset();" value="𝗖𝗮𝗻𝗰𝗲𝗹" class="btn btn-success ">
